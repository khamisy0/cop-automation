...
import { parseBrandManager, parseRHM } from '@/modules/cop/parser';
import { mergeAndCalculate, calculateSummary } from '@/modules/cop/transformer';
import { formatERPLines } from '@/modules/cop/formatter';
import {
...
/**
 * POST /api/cop
 * Handles file upload and processing for COP Automation
 *
